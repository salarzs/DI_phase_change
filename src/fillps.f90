...
module mod_fillps
 ...
 !call fillps(n(1),n(2),n(3),nh_d,nh_u,dxi,dyi,dzi,dzfi,f_t12_i,rho0,u,v,w,p,rhs_div_th*1.0)
  subroutine fillps(nx,ny,nz,nh_d,nh_u,dxi,dyi,dzi,dzfi,dti,rho0,u,v,w,p,rhs_div_th)
    !u and v and w contains density as well
    implicit none
    !
    ...
    real(rp), intent(in ), dimension(1-nh_u:,1-nh_u:,1-nh_u:) :: u,v,w,rhs_div_th
   ! real(rp), intent(in ), dimension(1-nh_u:,1-nh_u:,1-nh_u:) :: src
        ...
        do i=1,nx
          ...
          p(i,j,k) =  &
                     ((w(i,j,k)-w(i,j,km))*dti*dzfi(k) + &
                      ...
                      rhs_div_th(i,j,k)*dti 
                      !src(i,j,k)*(1.d0/rho2 - 1.d0/rho1)*dti 
          !    
