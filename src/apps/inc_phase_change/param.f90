...
module mod_param
  ...
  logical                              :: restart_mph_heat_scalar
  ...
  real(rp)                             :: Diff1,Diff2,A_rel,A_m,k_eq
  real(rp)                             :: theta,t_relax_i
  character(len=3)                     :: inivap
  ...
  subroutine read_input(myid)
    ...
    if( ierr.eq.0 ) then
      ...
      read(iunit,*) restart_mph_heat_scalar
