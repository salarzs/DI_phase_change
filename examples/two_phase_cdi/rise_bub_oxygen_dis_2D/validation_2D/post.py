...
direct     =   '/home/salarz/scratch/data_2D/'
...
for x in range(0,180000,30000):
   ...
   sns.lineplot(x=location,y=psi[1,:,48],marker='',linestyle='-',markersize=0,linewidth
...
for x in range(0,180000,30000):
   ...
   sns.lineplot(x=location,y=c2[1,:,48],marker='',linestyle='-',markersize=0,linewidth
                 ='2',ax=ax_main,label='t='+str(time*1e-6))
   time     = (time + 30000.0)
...
for x in range(0,180000,30000):
   ...
   sns.lineplot(x=location,y=c1[1,:,48],marker='',linestyle='-',markersize=0,linewidth
                 ='2',ax=ax_main,label='t='+str(time*1e-6))
   time     = (time + 30000.0)
...
for x in range(0,160000,10000):
   ...
   sns.lineplot(x=X_val,y=Y_val,linestyle='--',color='red',ax=ax_main)
...
legend_handles = [
    ...
    mlines.Line2D([], [], color='red', linestyle='dashed', label=legend_labels[1])
]
